...
const JOBS = [
  { src: "wagoll-wall.html",   out: "Pigeon-Patrol-WAGOLL-Wall-A3.pdf",
    opts: { format: "A3", landscape: true }, margin: "7mm",  expect: 1,
    note: "the whole continuum on one A3 landscape sheet" },
  { src: "level-sheets.html",  out: "Pigeon-Patrol-Level-Sheets-A3.pdf",
    opts: { format: "A3" },                  margin: "11mm", expect: 5,
    note: "one A3 portrait anchor sheet per level" }
];
